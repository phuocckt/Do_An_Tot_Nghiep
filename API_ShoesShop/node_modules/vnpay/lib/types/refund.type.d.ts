...
export type Refund = Partial<Pick<QueryDr, 'vnp_TransactionNo'>> & Pick<QueryDr, 'vnp_RequestId' | 'vnp_TransactionDate' | 'vnp_IpAddr'> & Pick<BuildPaymentUrl, 'vnp_Amount' | 'vnp_OrderInfo' | 'vnp_TxnRef'> & Partial<Pick<BuildPaymentUrl, 'vnp_Locale'>> & {
    /**
...
export type RefundResponseFromVNPay = Pick<QueryDrResponseFromVNPay, 'vnp_TxnRef' | 'vnp_Amount' | 'vnp_ResponseCode' | 'vnp_Message' | 'vnp_BankCode' | 'vnp_PayDate' | 'vnp_TransactionNo' | 'vnp_TransactionType' | 'vnp_TransactionStatus' | 'vnp_SecureHash'> & {
    /**

...
class VNPay {
    ...
    verifyReturnUrl(query, options) {
        ...
        if (typeof (cloneQuery === null || cloneQuery === void 0 ? void 0 : cloneQuery.vnp_Amount) !== 'number') {
            const res = constants_1.numberRegex.test((_a = cloneQuery === null || cloneQuery === void 0 ? void 0 : cloneQuery.vnp_Amount) !== null && _a !== void 0 ? _a : '');
            if (!res) {
    ...
    verifyIpnCall(query, options) {
        ...
        if (this.isEnableLog) {
            const data2Log = Object.assign({ createdAt: new Date(), method: this.verifyIpnCall.name }, result);
    ...
    queryDr(query, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stringToCreateHash = `${dataQuery.vnp_RequestId}|${dataQuery.vnp_Version}|${command}` +
            ...
            const outputResults = Object.assign(Object.assign({ isVerified: true, isSuccess: responseData.vnp_ResponseCode == '00', message }, responseData), { vnp_Message: message });
            let stringToCreateHashOfResponse = `${responseData.vnp_ResponseId}|${responseData.vnp_Command}|${responseData.vnp_ResponseCode}` +
            ...
            if (responseHashed !== responseData.vnp_SecureHash) {
                Object.assign(outputResults, {
                    isVerified: false,
                    message: (0, common_1.getResponseByStatusCode)(constants_1.WRONG_CHECKSUM_KEY, this.globalDefaultConfig.vnp_Locale, constants_1.QUERY_DR_RESPONSE_MAP),
                });
            }
            if (this.isEnableLog) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Number(responseData.vnp_ResponseCode) <= 90 &&
                ...
                let stringToCreateHashOfResponse = [
                    ...
                    (_e = responseData.vnp_TransactionNo) !== null && _e !== void 0 ? _e : '0',
                ...
                if (responseHashed !== responseData.vnp_SecureHash) {
                    Object.assign(outputResults, {
                        isVerified: false,
                        message: (0, common_1.getResponseByStatusCode)(constants_1.WRONG_CHECKSUM_KEY, this.globalDefaultConfig.vnp_Locale, constants_1.REFUND_RESPONSE_MAP),
                    });
                }
            }
            if (this.isEnableLog) {

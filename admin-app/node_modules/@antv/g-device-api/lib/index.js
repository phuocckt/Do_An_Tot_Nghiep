...
(function (Format) {
    ...
    Format[Format["U8_LUMINANCE"] = makeFormat(exports.FormatTypeFlags.U8, exports.FormatCompFlags.A, exports.FormatFlags.None)] = "U8_LUMINANCE";
    Format[Format["F16_LUMINANCE"] = makeFormat(exports.FormatTypeFlags.F16, exports.FormatCompFlags.A, exports.FormatFlags.None)] = "F16_LUMINANCE";
    Format[Format["F32_LUMINANCE"] = makeFormat(exports.FormatTypeFlags.F32, exports.FormatCompFlags.A, exports.FormatFlags.None)] = "F32_LUMINANCE";
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 9: return [2 /*return*/, new Device_WebGPU(adapter, device, $canvas, context, glsl_compile, new WGSLComposer())];
                }
            });
        });
    };
